...
model Examples_Extreme_Conditions
  ...
  Components.Environment environment(T_amb_mean = 36)  annotation(
  ...
  Components.Battery.Battery battery(operationMode = EVRanger.Components.Battery.BatteryOperationModeTypes.BatteryOperationMode.ReducedSOH, batteryType = EVRanger.Components.Battery.BatterySelectionTypes.BatterySelection.NMC_60kWh) annotation(
    Placement(visible = true, transformation(origin = {75, 77}, extent = {{-39, -39}, {39, 39}}, rotation = 0)));
  Components.Driver.MinimalDriver minimalDriver(operationMode = EVRanger.Components.Driver.DriverOperationModeTypes.DriverOperationMode.Speeding) annotation(
...
equation
  ...
  annotation(
    Diagram,
    Documentation(info = "<html><head></head><body><p style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">Example simulation with the NMC battery parameterisation in extreme external conditions.</p><p style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\">This showcases how the exteranl factors have an infuence on the range of the vehicle.</p><p style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><b><u>Parameterisation</u>&nbsp;</b></p><p style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><b>Battery:</b></p><p style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"></p><ul style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><li>NMC Battery Parameter</li><li>Initial SOH = 0.4 (40% due to i.e. production faults etc.)</li></ul><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><b>Environment:</b></div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><ul><li>Ambient Temperature = 36°C&nbsp;</li><li>Slope = 0.01 rad for 50km&nbsp;</li></ul><div><b>Driver:</b></div></div><div style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><ul><li>Speeding (drives 20% faster than the normal driver)</li></ul></div><p style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"></p><p style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><b>DC Motor &amp; Vehicle:&nbsp;</b></p><p style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"></p><ul style=\"font-family: 'MS Shell Dlg 2'; font-size: 12px;\"><li>Default Parameter</li></ul></body></html>"));
end Examples_Extreme_Conditions;
