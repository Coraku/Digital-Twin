...
annotation(
  ...
  Documentation(info = "<html><head></head><body><h4><b>Description</b></h4><h4><div style=\"font-weight: normal;\"><b><br></b></div><div style=\"font-weight: normal;\"><!--StartFragment-->This model represents a simple road, consisting of slope and friction along its length. For simplicity, the road is assumed to be infinitely long. The variables passed from the environment to the vehicle dynamics model are crucial for determining the correct counterforce.<!--EndFragment-->&nbsp;&nbsp;</div><div style=\"font-weight: normal;\"><br></div><div style=\"font-weight: normal;\"><br></div><div style=\"font-weight: normal;\"><b>Process</b></div><div style=\"font-weight: normal;\"><b><br></b></div><div style=\"font-weight: normal;\"><b><br></b><!--StartFragment-->Both the slope and the friction are calculated by separate functions: the&nbsp;<em data-start=\"118\" data-end=\"135\">fSlopeGenerator</em>&nbsp;function and the<em data-start=\"153\" data-end=\"173\">&nbsp;fFrictionGenerator</em>&nbsp;function. Additionally, a sinusoidal function calculates the current temperature, which is used in the battery model.</div></h4><div><br></div></body></html>"));
end Environment;
