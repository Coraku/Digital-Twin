...
equation
  ...
  if batteryAvailableSignal.batteryAvailable then //if the Battery is empty, the torque of the Motor becomes 0
  ...
  annotation(
    ...
    Diagram(graphics),
  Documentation(info = "<html><head></head><body><p style=\"font-size: 12px;\"><strong><u>Information</u></strong></p><div class=\"textDoc\"><p style=\"font-family: 'Courier New'; font-size: 12px;\"></p></div><div class=\"htmlDoc\" style=\"font-family: 'MS Shell Dlg 2';\"><h4><b>Description</b></h4><h4><div style=\"font-weight: normal;\"><b><br></b></div><div style=\"font-weight: normal;\"><!--StartFragment-->This model represents the motor controller. It calculates the motor torque using a classical feedback control loop with a proportional gain controller. In the case of an empty battery, the motor controller outputs zero torque.<!--EndFragment-->&nbsp;&nbsp;</div><div style=\"font-weight: normal;\"><br></div><div style=\"font-weight: normal;\"><br></div><div style=\"font-weight: normal;\"><b>Process</b></div><div style=\"font-weight: normal;\"><b><br><br></b></div><div style=\"font-weight: normal;\"><!--StartFragment-->The controller calculates the motor torque by comparing the actual velocity of the car with the desired velocity provided by the driver. If the battery signals that it has reached the cut-off capacity, the controller stops the motor.<!--EndFragment-->&nbsp;&nbsp;</div></h4></div></body></html>"));
end MotorController;
