...
package Battery
  ...
  model Battery
    ...
    parameter Units.Resistance R_int = batt.R_int;
    parameter Real Q_nom = batt.Q_nom;
    parameter Real beta_degrad = batt.beta_degrad;
    parameter Units.DegradationRate degradation_rate = batt.degradation_rate;
    parameter Units.Mass m_batt = batt.m_batt;
    parameter Units.SpecificHeatCapacity c_p = batt.c_p;
    parameter Units.HeatTransferCoefficient h = batt.h;
    parameter Units.Area A = batt.A;
    // Common parameters
    parameter Units.Temperature_degC T_ref = 25 "Reference temperature";
    //  parameter Real T_amb = 25 "Ambient temperature";
    ...
    Units.Temperature_degC T(start = T_ref) "Battery temperature";
    Units.Current I_batt "Battery current";
    Units.Voltage V_t "Terminal voltage";
    Units.Voltage V_oc "Open-circuit voltage";
    Units.Resistance R_int_T "Temperature-adjusted resistance";
    Units.Power Q_gen "Generated heat";
    Units.Power Q_loss "Heat loss";
    Real Q_eff "Effective capacity";
    Real SOC_out;
    output Units.Temperature_degC T_out;
    output Real SOH_out;
 ...
 //Documentation(info = "<html><head></head><body>This is a great battery</body></html>")
  ...
  package Records
    record BatteryParams
      parameter Units.Resistance R_int "Internal resistance";
      parameter Units.Charge Q_nom "Nominal capacity";
      parameter Units.TemperatureCoefficient beta_degrad "Temperature sensitivity of aging (1/K)";
      parameter Units.DegradationRate degradation_rate "SOH degradation rate (1/C)";
      parameter Units.Mass m_batt "Battery mass";
      parameter Units.SpecificHeatCapacity c_p "Specific heat capacity";
      parameter Units.HeatTransferCoefficient h "Heat transfer coefficient";
      parameter Units.Area A "Surface area";
    end BatteryParams;
    annotation(
