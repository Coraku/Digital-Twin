...
model DCMotor "Basic Lynch Type DC Motor"
  ...
  EVRanger.Interfaces.ElectricalPort electricalPortIn annotation(
    Placement(visible = true, transformation(origin = {-2, 76}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {50, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  EVRanger.Interfaces.MechanicalPort mechanicalPortOut annotation(
    Placement(visible = true, transformation(origin = {-2, -76}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  // Signals
  input EVRanger.Interfaces.TorqueSignal torqueSignal annotation(
    Placement(visible = true, transformation(origin = {-24, 74}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-90, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  input EVRanger.Interfaces.BatteryAvailableSignal batteryAvailableSignal annotation(
    Placement(visible = true, transformation(origin = {-88, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-30, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
//protected
...
// Assign signal & flow values
  ...
  annotation(
    Icon(graphics = {Ellipse(lineColor = {170, 0, 255}, fillColor = {170, 0, 255}, fillPattern = FillPattern.Solid,extent = {{-30, 30}, {30, -30}}, endAngle = 360), Ellipse(origin = {1.03, 0.02}, lineColor = {170, 0, 255}, lineThickness = 2, extent = {{-79.53, 79.21}, {79.53, -79.21}}, endAngle = 360), Polygon(origin = {-58, 0}, lineColor = {170, 0, 255}, fillColor = {170, 0, 255}, fillPattern = FillPattern.Solid, points = {{-20, 20}, {20, 20}, {16, 16}, {12, 10}, {12, 0}, {12, -8}, {16, -16}, {20, -20}, {-20, -20}, {-20, 20}}), Polygon(origin = {0, 58}, rotation = -90, lineColor = {170, 0, 255}, fillColor = {170, 0, 255}, fillPattern = FillPattern.Solid, points = {{-20, 20}, {20, 20}, {16, 16}, {12, 10}, {12, 0}, {12, -8}, {16, -16}, {20, -20}, {-20, -20}, {-20, 20}}), Polygon(origin = {60, 0}, rotation = 180, lineColor = {170, 0, 255}, fillColor = {170, 0, 255}, fillPattern = FillPattern.Solid, points = {{-20, 20}, {20, 20}, {16, 16}, {12, 10}, {12, 0}, {12, -8}, {16, -16}, {20, -20}, {-20, -20}, {-20, 20}}), Polygon(origin = {0, -58}, rotation = 90, lineColor = {170, 0, 255}, fillColor = {170, 0, 255}, fillPattern = FillPattern.Solid, points = {{-20, 20}, {20, 20}, {16, 16}, {12, 10}, {12, 0}, {12, -8}, {16, -16}, {20, -20}, {-20, -20}, {-20, 20}}), Rectangle(origin = {0, 1}, lineThickness = 0.5, extent = {{-88, 89}, {88, -89}})}));
end DCMotor;
